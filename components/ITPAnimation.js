...
const ITPAnimation = ({value, rotation}) => (
  <View>
    ...
    />
    <View style={{alignItems: 'center', justifyContent: 'center', width: 100, height: 100, backgroundColor: COLOR2(1-value)}}>
      <Text style={{color: 'white', fontSize: value*30}}>In the Pocket</Text>
    </View>
  </View>
);
